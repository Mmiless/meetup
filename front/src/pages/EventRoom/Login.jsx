...
const Login = ({ onSubmit }) => {
    ...
    return (
        <form className="w-80 flex flex-col p-4 space-y-4 font-source-code" onSubmit={handleSubmit}>
            <label className="nameLabel font-semibold" htmlFor="eventName">Name</label>
            ...
            <label className="nameLabel font-semibold" htmlFor="eventName">Password (Optional)</label>
            ...
            <button className="bg-black text-white font-bold py-2 px-4 rounded-lg hover:bg-green-600 transition" type="submit">Log In / Sign Up</button>
        </form>
    );
};  
